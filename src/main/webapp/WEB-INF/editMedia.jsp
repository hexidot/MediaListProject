...
<html>
    <head>
        ...
        <title>Editing <c:out value="${currentMedia.name}"/></title>
    </head>
    <body>
        <header>
                ...
                <div class="container-fluid">
                    ...
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#main-navbar" aria-controls="main-navbar" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon">
                    	    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-caret-down-square" viewBox="0 0 16 16">
            ...
            <div class="text-primary p-4">
                <h1>Editing <c:out value="${currentMedia.name}"/></h1>
            </div>
        </header>
        <main class="px-5 m-5">
            <form:form action="/media/${currentMedia.id}/edit" method="post" modelAttribute="currentMedia">
                ...
                <form:input type="hidden" path="parentList" value="${currentMedia.parentList.id}"/>
